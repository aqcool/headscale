...
const file_proto_v1_node_proto_rawDesc = "" +
	"\n" +
	"\x13proto/v1/node.proto\x12\fheadscale.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19proto/v1/preauthkey.proto\x1a\x13proto/v1/user.proto\"\xc9\x05\n" +
	"\x04Node\x12\x0e\n" +
	...
	"\x14REGISTER_METHOD_OIDC\x10\x03B2Z0github.com/juanfont/headscale-v2/api/proto/v1;v1b\x06proto3"
...
var file_proto_v1_node_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
