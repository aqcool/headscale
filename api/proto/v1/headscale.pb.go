...
func (x *HealthRequest) Reset() {
	*x = HealthRequest{}
	mi := &file_proto_v1_headscale_proto_msgTypes[0]
...
func (*HealthRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_headscale_proto_rawDescGZIP(), []int{0}
}
...
func (x *HealthResponse) Reset() {
	*x = HealthResponse{}
	mi := &file_proto_v1_headscale_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HealthResponse) Descriptor() ([]byte, []int) {
	return file_proto_v1_headscale_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_v1_headscale_proto protoreflect.FileDescriptor

const file_proto_v1_headscale_proto_rawDesc = "" +
	"\n" +
	"\x18proto/v1/headscale.proto\x12\fheadscale.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x13proto/v1/user.proto\x1a\x19proto/v1/preauthkey.proto\x1a\x13proto/v1/node.proto\x1a\x15proto/v1/apikey.proto\x1a\x13proto/v1/auth.proto\x1a\x15proto/v1/policy.proto\"\x0f\n" +
	"\rHealthRequest\"E\n" +
	...
	"\x06Health\x12\x1b.headscale.v1.HealthRequest\x1a\x1c.headscale.v1.HealthResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/api/v1/healthB2Z0github.com/juanfont/headscale-v2/api/proto/v1;v1b\x06proto3"

var (
	file_proto_v1_headscale_proto_rawDescOnce sync.Once
	file_proto_v1_headscale_proto_rawDescData []byte
)

func file_proto_v1_headscale_proto_rawDescGZIP() []byte {
	file_proto_v1_headscale_proto_rawDescOnce.Do(func() {
		file_proto_v1_headscale_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_v1_headscale_proto_rawDesc), len(file_proto_v1_headscale_proto_rawDesc)))
	})
	return file_proto_v1_headscale_proto_rawDescData
}

var file_proto_v1_headscale_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_v1_headscale_proto_goTypes = []any{
...
var file_proto_v1_headscale_proto_depIdxs = []int32{
...
func init() { file_proto_v1_headscale_proto_init() }
func file_proto_v1_headscale_proto_init() {
	if File_proto_v1_headscale_proto != nil {
		return
	}
	file_proto_v1_user_proto_init()
	file_proto_v1_preauthkey_proto_init()
	file_proto_v1_node_proto_init()
	file_proto_v1_apikey_proto_init()
	file_proto_v1_auth_proto_init()
	file_proto_v1_policy_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_v1_headscale_proto_rawDesc), len(file_proto_v1_headscale_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_v1_headscale_proto_goTypes,
		DependencyIndexes: file_proto_v1_headscale_proto_depIdxs,
		MessageInfos:      file_proto_v1_headscale_proto_msgTypes,
	}.Build()
	File_proto_v1_headscale_proto = out.File
	file_proto_v1_headscale_proto_goTypes = nil
	file_proto_v1_headscale_proto_depIdxs = nil
}
